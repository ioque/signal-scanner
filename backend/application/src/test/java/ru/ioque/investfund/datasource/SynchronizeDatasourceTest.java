...
@DisplayName("SYNCHRONIZE DATASOURCE TEST")
public class SynchronizeDatasourceTest extends BaseTest {
    @BeforeEach
    void beforeEach() {
        commandBus().execute(
    ...
    @Test
    @DisplayName("""
        T6. В команде на запуск интеграции инструментов не передан идентификатор источника данных.
        """)
    void testCase6() {
