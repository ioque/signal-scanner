...
public class RemoveDatasourceHandler extends CommandHandler<RemoveDatasource> {
    DatasourceRepository datasourceRepository;

    public RemoveDatasourceHandler(
    ...
    @Override
    protected Result businessProcess(RemoveDatasource command) {
