...
public class EnableUpdateInstrumentsCommand extends Command {
    ...
    @Builder
    public EnableUpdateInstrumentsCommand(UUID track, DatasourceId datasourceId, List<Ticker> tickers) {
        super(track);
