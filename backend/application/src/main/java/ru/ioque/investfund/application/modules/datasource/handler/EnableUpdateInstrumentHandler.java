...
public class EnableUpdateInstrumentHandler extends CommandHandler<EnableUpdateInstruments> {
    ...
    @Override
    protected Result businessProcess(EnableUpdateInstruments command) {
